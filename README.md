...
![软件主界面 · 浅色](assets/ui_light_20260815.png)

软件主界面 · 深色主题：

![软件主界面 · 深色](assets/ui_dark_20260815.png)

设置对话框：

![设置对话框 · 浅色](assets/ui_settings_light_20260815.png)

![设置对话框 · 深色](assets/ui_settings_dark_20260815.png)

导出的 HTML 目录报告（演示数据）：

![HTML 目录报告界面](assets/screenshot_html_20260815.png)
