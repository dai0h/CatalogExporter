...
class CoreTests(unittest.TestCase):
    ...
    def test_export_html(self):
        ...
        self.assertIn(str(disk_root).replace("\\", "\\\\"), content)
        self.assertIn("const DATA =", content)
        self.assertIn("const DISK_INFO =", content)
        self.assertIn('id="tree"', content)
        self.assertIn('id="viewBtn"', content)
        self.assertIn('id="parentBtn"', content)
        self.assertIn(".. 返回上一级", content)
        self.assertIn("enterDirectory", content)
        self.assertIn("setExpandedToPath", content)
        self.assertIn("type-icon", content)
        self.assertIn("ext-tag", content)
        self.assertIn("art-folder", content)
        self.assertIn("art-video", content)
        self.assertIn("renderCards", content)
        self.assertIn("capacityBar", content)
